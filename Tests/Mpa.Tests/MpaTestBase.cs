...
namespace Mpa.Tests
{
    public abstract class MpaTestBase : AbpIntegratedTestBase<MpaTestModule>
    {
        ...
        protected Task UsingDbContextAsync(Func<MpaDbContext, Task> action)
        {
        ...
        protected Task<T> UsingDbContextAsync<T>(Func<MpaDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<MpaDbContext> action)
        {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<MpaDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<MpaDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<MpaDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<MpaDbContext, Task<T>> func)
        {
            T result;
